...
| 2026-07-29 | 2–3 | **Recommend dropping.** Caching was scoped to remove a ~3s DB wait that no longer exists. Revisit only if traffic grows enough that DB *load* (not latency) becomes the constraint. |
