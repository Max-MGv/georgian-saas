...
- [ ] **Printable daily booking sheet** — A4-format printout for staff to check bookings; rows grouped by day, each row shows one booking with all relevant info (name, time, guests, visit type, company, notes). Not started yet. *(Draft: trigger/page location still TBD)*
