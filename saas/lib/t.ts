...
const en: Translations = {
  ...
  'about.heading': 'About Nikalas Marani',
  ...
  'contact.note_location': 'Kakheti region, Eastern Georgia',
  'contact.note_cancel': 'Please notify us at least 48 hours before your visit',
  'contact.cancel_value': '48-hour policy',
  'contact.map_placeholder': 'Kardanakhi, Gurjaani Municipality, Kakheti, Georgia',
  'contact.map_directions': 'We are located in the village of Kardanakhi, about 15 minutes from Gurjaani town. Exact directions are sent with your booking confirmation.',
...
const ka: Translations = {
  ...
  'about.heading': 'ნიკალას მარანის შესახებ',
  ...
  'contact.note_location': 'კახეთის რეგიონი, აღმოსავლეთ საქართველო',
  'contact.note_cancel': 'გთხოვთ, გვაცნობოთ მინიმუმ 48 საათით ადრე',
  'contact.cancel_value': '48-საათიანი პოლიტიკა',
  'contact.map_placeholder': 'კარდანახი, გურჯაანის მუნიციპალიტეტი, კახეთი, საქართველო',
  'contact.map_directions': 'ჩვენ ვმდებარეობთ კარდანახის სოფელში, გურჯაანი ქალაქიდან დაახლოებით 15 წუთის სავალზე. ზუსტი მარშრუტი გაიგზავნება ჯავშნის დადასტურებასთან ერთად.',
