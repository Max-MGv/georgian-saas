...
export default async function ReturnsPage() {
  ...
  const content = await getContent('legal_returns_body', LEGAL_CONTENT_EN.legal_returns_body, locale)

  return <LegalPageLayout locale={locale} title={t(locale, 'legal.returns_title')} content={content} />
}
