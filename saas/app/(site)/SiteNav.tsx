...
function SocialIcons({ email, phone, facebook, instagram }: { email: string; phone: string; facebook: string; instagram: string }) {
  ...
  return (
    <div className="flex items-center gap-4">
      {phone && (
        <a href={`tel:${phone.replace(/\s/g, '')}`} title={phone} className="opacity-70 hover:opacity-100 transition-opacity px-2 py-3 -mx-2 -my-3 md:p-0 md:m-0">
      ...
      {email && (
        <a href={`mailto:${email}`} title={email} className="opacity-70 hover:opacity-100 transition-opacity px-2 py-3 -mx-2 -my-3 md:p-0 md:m-0">
          <svg width="17" height="17" viewBox="0 0 512 512" fill="var(--color-brand)">
      ...
      {facebook && (
        <a href={facebook} target="_blank" rel="noopener noreferrer" title="Facebook" className="opacity-70 hover:opacity-100 transition-opacity px-2 py-3 -mx-2 -my-3 md:p-0 md:m-0">
      ...
      {instagram && (
        <a href={instagram} target="_blank" rel="noopener noreferrer" title="Instagram" className="opacity-70 hover:opacity-100 transition-opacity px-2 py-3 -mx-2 -my-3 md:p-0 md:m-0">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="var(--color-brand)">
      ...
      <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex md:hidden items-center gap-4">
          ...
          <button
            onClick={() => setOpen(o => !o)}
            aria-label="Menu"
            className="p-2.5 -m-1.5 rounded transition-opacity hover:opacity-70"
