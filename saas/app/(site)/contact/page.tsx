    ...
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
        {[
          {
            label: 'Phone',
            value: '+995 599 96 33 17',
            note: 'Call or WhatsApp, Georgian or English',
          },
          {
            label: 'Email',
            value: 'nikalasmarani@gmail.com',
            note: 'We reply within 24 hours',
          },
          {
            label: 'Location',
            value: 'Kardanakhi, Gurjaani',
            note: 'Kakheti region, Eastern Georgia',
          },
          {
            label: 'Cancellation',
            value: '48-hour policy',
            note: 'Please notify us at least 48 hours before your visit',
          },
        ].map(item => (
      ...
      <section className="mb-12">
        ...
        <div
          className="w-full h-64 rounded-xl border flex items-center justify-center text-sm"
        ...
        <p className="text-sm mt-3" style={{ color: '#6b5a47' }}>
          We are located in the village of Kardanakhi, about 15 minutes from Gurjaani town.
          Exact directions are sent with your booking confirmation.
        </p>
      </section>
