...
export default async function TermsPage() {
  ...
  const content = await getContent('legal_terms_body', LEGAL_CONTENT_EN.legal_terms_body, locale)

  return <LegalPageLayout locale={locale} title={t(locale, 'legal.terms_title')} content={content} />
}
