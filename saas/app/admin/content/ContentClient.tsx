...
const FIELDS: Record<SectionKey, FieldDef[]> = {
  ...
  about: [
    ...
    { key: 'about_story_p1',       label: 'Story — paragraph 1',      fallback: 'A family winery producing traditional Georgian wine.' },
    { key: 'about_story_p2',       label: 'Story — paragraph 2',      fallback: 'Our wines are made with minimal intervention — the grapes, the sun, and the clay vessels do most of the work.' },
    { key: 'about_story_p3',       label: 'Story — paragraph 3',      fallback: 'We welcome visitors to experience Georgian wine culture firsthand — at the table, with food, conversation, and the winemaker.' },
